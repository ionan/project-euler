    ...
    for i in xrange(0,19):
        ...
        while j < 20:
            if j + 4 < 20:
                ...
                elif i + 4 < 20 and matrix[i][j] * matrix[i+1][j+1] * matrix[i+2][j+2] * matrix[i+3][j+3] > max_product:
                ...
                if i + 4 < 20 and matrix[i][j] * matrix[i+1][j-1] * matrix[i+2][j-2] * matrix[i+3][j-3] > max_product:
                    ...
                    max_product = matrix[i][j] * matrix[i-1][j-1] * matrix[i-2][j-2] * matrix[i-3][j-3]
            j = j + 1
    print 'Max product: ' + str(max_product) + '(calculated in ' + str(time.clock() - start) + ')'
